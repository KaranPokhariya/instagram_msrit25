...
options.add_extension("/Users/architnanda/Downloads/instagram_msrit_25/extension.crx")
...
username.clear()
username.send_keys("bindra.arnav")
password.clear()
password.send_keys("Jack_saw_what?")
...
for i,account in enumerate(to_get_followers):
    ...
    try:
        ...
        time.sleep(10)
        try:
            os.system('mv /Users/architnanda/Downloads/{}_followers.csv /Users/architnanda/Downloads/instagram_msrit_25/accounts'.format(account))
        except:
